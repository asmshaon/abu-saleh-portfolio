      ...
      <nav className="navbar">
        <div className="navbar-inner">
          ...
          >
            ...
            <div className="navbar-logo-info hidden sm:block">
              <div className="navbar-logo-name">Abu Saleh</div>
              <div className="navbar-logo-role">Senior Software Engineer</div>
            </div>
          </a>

          {/* Desktop Links */}
          <div className="navbar-links hidden lg:flex items-center gap-8">
            {menuItems.map((item) => (
              <a
                key={item.id}
                href={`#${item.id}`}
          ...
          <div className="navbar-right">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="navbar-social hidden sm:flex"
